...
.LFE1776:
	...
	.section	.rodata
	.align 4
	.type	_ZL10ARRAY_SIZE, @object
	.size	_ZL10ARRAY_SIZE, 4
_ZL10ARRAY_SIZE:
	.long	67108864
	.text
...
.L22:
	...
	cltq
	leaq	0(,%rax,4), %rdx
	leaq	_ZZ4mainE7array_a(%rip), %rax
	movss	%xmm0, (%rdx,%rax)
	call	rand@PLT
	cvtsi2ssl	%eax, %xmm1
	movss	.LC0(%rip), %xmm0
	...
	cltq
	leaq	0(,%rax,4), %rdx
	leaq	_ZZ4mainE7array_b(%rip), %rax
	movss	%xmm0, (%rdx,%rax)
	addl	$1, -108(%rbp)
	jmp	.L22
.L21:
	...
	movq	%rax, -104(%rbp)
	leaq	_ZZ4mainE7array_c(%rip), %rdx
	leaq	_ZZ4mainE7array_b(%rip), %rsi
	leaq	_ZZ4mainE7array_a(%rip), %rdi
...
.LLSDACSB1795:
	.uleb128 .LEHB0-.LFB1795
	.uleb128 .LEHE0-.LEHB0
	.uleb128 0
	.uleb128 0
	.uleb128 .LEHB1-.LFB1795
	.uleb128 .LEHE1-.LEHB1
	.uleb128 .L26-.LFB1795
	.uleb128 0
	.uleb128 .LEHB2-.LFB1795
	.uleb128 .LEHE2-.LEHB2
	.uleb128 0
	.uleb128 0
.LLSDACSE1795:
